...
public abstract class Hero {
    ...
    public String toString(){
        return ((this instanceof Warrior ? "Warrrior":"Hunter")+"(Hero) <lifePoints: "+lifePoints+", armor: "+armor+", weaponDamage: "+weaponDamage+", nPotions: "+potions.size()+", nLembas: "+lembas.size()+">");
    }
}